...
export class Morphic {
    constructor() {
        this.account = {
            cookie: "",
            email: "jocktmp+iyxe0@gmail.com",
            pass: "12345Pwd.",
        };
    }
    ...
    chat() {
        return __awaiter(this, arguments, void 0, function* (data = "hi!!", files = []) {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                var _a, _b, _c, _d, _e;
                try {
                    let prompt;
                    ...
                    form.append("3_files", JSON.stringify(files));
                    ...
                    const r = yield axios
                        .post(this.account.cookie
                        ? "https://www.morphic.sh/" + id
                        : "https://www.morphic.sh/", form, {
